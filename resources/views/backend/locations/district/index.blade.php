            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-header bg-white border-0 py-3 d-flex align-items-center justify-content-between">
                    <h5 class="mb-0 text-primary fw-bold">
                        <i class="ti ti-map-pin me-2"></i>District Management
                    </h5>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Bulk Import Districts</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <form action="{{ route('backend.districts.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
        ...
        $(document).ready(function() {
            ...
            const table = CRUD.loadDataTable([{
                ...
                },
                {
                    ...
                    name: 'state_name',
                    render: (data) =>
                        `<span class="badge bg-light-primary text-primary rounded-pill px-3">${data}</span>`
                },
            ...
            if (typeof Choices !== 'undefined') {
                ...
                if (el) {
                    CRUD.initAjaxChoices(el, "{{ route('backend.states.search') }}", "Search state...");
