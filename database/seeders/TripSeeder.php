...
class TripSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $trips[] = [
            ...
            ['bus_id' => 5, 'route_id' => 1, 'departure_time' => '17:15', 'arrival_time' => '18:00', 'days_of_week' => $days], // MKD - TVK
        ];
        ...
        $trips[] = [
            ...
            ['bus_id' => 6, 'route_id' => 1, 'departure_time' => '19:40', 'arrival_time' => '20:25', 'days_of_week' => $days], // MKD - TVK
        ];
